...
import (
	...
	"github.com/quantumworld-dpdns-io/escort-compliance-crm/services/credentials/internal/credentials/router"
...
func main() {
	...
	fmt.Printf("Credentials service starting on port %s\n", port)
